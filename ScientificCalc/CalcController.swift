...
class CalcController: UIViewController {
    ...
    @IBAction func AnsBefore(_ sender: Any) {
        Formula.text = calc.AnsBefore()
    }
    
    @IBAction func Point(_ sender: Any) {
        Formula.text = calc.Point()
    }
    
    @IBAction func Multiplier(_ sender: Any) {
        Formula.text = calc.Multiplier()
    }
}
